...
public class SipSender {
    ...
    private String ipTujuan = "voiprakyat.or.id";
    ...
    private static String registrar = "sip:"+ipTujuan;
    ...
    private Request createRequest(String tujuan, String command) throws ParseException, InvalidArgumentException {
